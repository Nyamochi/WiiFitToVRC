...
/// (thresholds/durations 50% larger, harder to trigger -- "insensitive") and 100 -> 0.5x (50%
/// smaller, easier to trigger -- "sensitive").
/// </summary>
public static class GestureSensitivityScale
{
    ...
    /// <summary>0 is the bottom of the "Insensitive" end of the scale, but doesn't just make the gesture
