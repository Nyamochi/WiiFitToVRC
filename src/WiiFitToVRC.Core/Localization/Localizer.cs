...
public static class Localizer
{
    ...
    private static readonly Dictionary<string, string[]> Table = new()
    {
        ...
        ["Settings_GestureSensitivity"] = ["Gesture sensitivity (turn / jump / crouch)", "反応のしやすさ", "反应灵敏度(转向/跳跃/下蹲)", "反應靈敏度(轉向/跳躍/蹲下)", "반응 민감도(회전/점프/웅크리기)", "Sensibilité des gestes (rotation/saut/accroupissement)", "Gesten-Empfindlichkeit (Drehen/Sprung/Ducken)", "Sensibilità dei gesti (rotazione/salto/accovacciamento)"],
