...
static void RunOneFile(string path, bool footstepTurnMode)
{
    ...
    foreach (string line in File.ReadLines(path).Skip(1))
    {
        ...
        var direction = directionClassifier.Update(cal, unixMs, isPresent: true, footstepThresholdRatio: 1.20, dashPeriodMs: 300, stepHoldMs: 70, stepContinuationMs: 900, continuationStepCount: 3, turnSensitivity: 50, footstepTurnMode);
...
static void SeedReference(DirectionClassifier directionClassifier, long realFirstUnixMs, bool footstepTurnMode)
{
    ...
    for (int i = 5; i >= 1; i--)
    {
        ...
        directionClassifier.Update(flatReading, sampleMs, isPresent: true, footstepThresholdRatio: 1.20, dashPeriodMs: 300, stepHoldMs: 70, stepContinuationMs: 900, continuationStepCount: 3, turnSensitivity: 50, footstepTurnMode);
    }
}
